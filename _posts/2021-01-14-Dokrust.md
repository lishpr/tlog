...
There are great, open-source options for full-fledged linux containers apps like Docker or Linux containers. I read about the wiring of containers in general (a summary can be found [here](https://lishpr.github.io/log/2021-01-14/How-Linux-Containers-Work)). But Docker and Linux containers are a hard read and too complicated to be disentangled for my use by myself.
